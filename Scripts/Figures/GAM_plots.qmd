...
annotate_figure(t1, left= textGrob("Partial effect", rot=90), fig.lab= "A)")
ggsave("/users/sallydowd/Desktop/Ch1Data/Figures/partial_rd.jpeg", width= 8, height= 6)
```
...
annotate_figure(t2, left= textGrob("Partial effect", rot=90), fig.lab= "B)")
ggsave("/users/sallydowd/Desktop/Ch1Data/Figures/partial_sk.jpeg", width= 8, height= 6)
```
...
annotate_figure(t3, left= textGrob("Partial effect", rot=90), fig.lab= "C)")
ggsave("/users/sallydowd/Desktop/Ch1Data/Figures/partial_bd.jpeg", width= 8, height= 6)
```
