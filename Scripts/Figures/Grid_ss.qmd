...
ggplot(data, aes(x = "", y = count, fill = species)) + geom_bar(stat = "identity", width = 0.8) + standard_theme + labs(x= "0.12° x 0.12°", y= "Number of encounters", fill= "Species") + scale_fill_manual(values= c("#0072B2", "#009E73", "#CC6666"), name= "Species")
