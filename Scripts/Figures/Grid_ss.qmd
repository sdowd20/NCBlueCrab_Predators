...
library(ggpubr)
library(grid)
ya <- ggarrange(t1 + rremove("ylab") + rremove("xlab"),t2 + rremove("ylab") + rremove("xlab"),t3 + rremove("ylab") + rremove("xlab"), common.legend= TRUE, ncol= 3, nrow=1)
annotate_figure(ya, bottom= text_grob("Longitude"), left= text_grob("Latitude", rot= 90))
ggsave("~/Desktop/Ch1Data/Figures/gridded_map_compare.jpeg", width= 12, height=7)
```
