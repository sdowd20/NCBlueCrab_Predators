...
p120 <- read.csv("p120/p120clean.csv") #make species name go to lower
p120_speciesn <- read.csv("p120/species_names.csv") 
p915 <- read.csv("p915/Data/p915clean.csv")
p195 <- read.csv("p195/p195clean.csv") #has a couple of less common species without common names, remove these!!! 
...
ggplot() + geom_histogram(data = total, aes(x=Stemp), bins = 100) + facet_wrap(~Survey) + standard_theme #temperature at which surveys occur
...
#### Overlap df: spatial and temporal
```{r}
...
```{r}
#Species-specific 
ggplot() + geom_sf(data = world) + geom_point(data = subset(total_edt, Species == "blue crab"), aes(x = Longitude, y = Latitude)) + scale_size_area() + facet_wrap(~Survey) + coord_sf(xlim=c(-78, -75), ylim=c(34,37), expand = TRUE) + theme(panel.background = element_rect(fill = "white", colour = "black"))

ggplot() + geom_sf(data = world) + geom_point(data = subset(total_edt, Species == "red drum"), aes(x = Longitude, y = Latitude)) + scale_size_area() + facet_wrap(~Survey) + coord_sf(xlim=c(-78, -75), ylim=c(34,37), expand = TRUE) + theme(panel.background = element_rect(fill = "white", colour = "black"))

ggplot() + geom_sf(data = world) + geom_point(data = subset(total_edt, Survey == "P915"), aes(x = Longitude, y = Latitude)) + scale_size_area() + facet_wrap(~Survey + Year, nrow = 6)  + coord_sf(xlim=c(-78, -75), ylim=c(34,37), expand = TRUE) + theme(panel.background = element_rect(fill = "white", colour = "black"))
ggsave("/users/sallydowd/desktop/allspecs.P915.jpg", width=25, height= 25, units= c("cm"))

ggplot() + geom_sf(data = world) + geom_point(data = subset(total_edt, Survey == "P120"), aes(x = Longitude, y = Latitude)) + scale_size_area() + facet_wrap(~Survey + Year, nrow = 6)  + coord_sf(xlim=c(-78, -75), ylim=c(34,37), expand = TRUE) + theme(panel.background = element_rect(fill = "white", colour = "black"))
ggsave("/users/sallydowd/desktop/allspecs.P120.jpg", width=25, height= 25, units= c("cm"))

ggplot() + geom_sf(data = world) + geom_point(data = subset(total_edt, Survey == "P195"), aes(x = Longitude, y = Latitude)) + scale_size_area() + facet_wrap(~Survey + Year, nrow = 6)  + coord_sf(xlim=c(-78, -75), ylim=c(34,37), expand = TRUE) + theme(panel.background = element_rect(fill = "white", colour = "black"))
ggsave("/users/sallydowd/desktop/allspecs.P195.jpg", width=25, height= 25, units= c("cm"))
