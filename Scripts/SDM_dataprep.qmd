...
st_write(datasets_Sedsize, "~/Desktop/datasets_Sedsize_sf.csv")
...
```{r}
Overall_grid8 <- read.csv("~/Documents/GitHub/NCBlueCrab_Predators/Data/Overall_grid8.csv")
