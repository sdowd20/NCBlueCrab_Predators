...
#Distance to SAV
coords_SAV_nearest <- st_nearest_feature(subset(coords_surveysf, Year== 2008), inlet_coords)
dist_SAV = st_distance(subset(coords_surveysf, Year == 2008), inlet_coords[coords_inlet_nearest,], by_element=TRUE)
