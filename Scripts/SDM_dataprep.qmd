...
CPUE_dfs_gridded_final <- CPUE_dfs_gridded %>% drop_na() %>% filter(!Wbd %in% "Tar River Reservoir-Tar River") #remove 66 rows (49 for NA in gridID and 17 for removing Tar River Wbd)
