...
write.csv(Grid_predictors_edt2final, "~/Desktop/gridded_predictors_final.csv")
```
...
#write.csv(CPUE_all_grid_pred,"~/Documents/GitHub/NCBlueCrab_Predators/Data/CPUE_all_grid_pred.csv") #updated on 08/22/23
```
