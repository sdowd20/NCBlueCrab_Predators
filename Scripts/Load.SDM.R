...
df_count_wide_P915 <- df_count_wide_P915 %>% dplyr::select(Month:avgsdo, atlanticcroaker, blackdrum, bluecrab, bonnetheadshark, bullshark, cownoseray, atlanticmenhaden, gizzardshad, reddrum, southernflounder, southernkingfish, spot, stripedbass, stripedmullet, summerflounder, pinfish, sheepshead, spottedseatrout)
