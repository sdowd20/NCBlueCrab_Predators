...
#Test overfitting with predictor variable effects
plot(reddrum_env, shade= TRUE, seWithMean= TRUE, scale=0)
```
...
#Test overfitting with predictor variable effects
plot(reddrum_env_forage, shade= TRUE, seWithMean= TRUE, scale=0)

AIC(reddrum_env_forage, reddrum_env)
```
...
#more interpretation: https://www.analyticsvidhya.com/blog/2023/09/understanding-generalized-additive-models-gams-a-comprehensive-guide/
