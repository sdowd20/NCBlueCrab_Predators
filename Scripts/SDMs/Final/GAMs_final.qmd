...
picked_inf = sample(seq_len(nrow(df_CPUE_length_wide_both)),size = inf_ss)
...
#Load formulas 
##Red drum
allformulas_reddrum <- dredgeform(pred = "reddrumP915", covars = c("s(avgdepth)", "s(avgssal)", "s(avgstemp)", "s(avgsdo)", "s(SAVkm)", "s(NoFishRest)", "factor(Yearfactor)"))
```
...
#Load formulas
##Red drum
allformulas_reddrum_M2 <- dredgeform(pred = "reddrumP915", covars = c("s(avgdepth)", "s(avgssal)", "s(avgstemp)", "s(avgsdo)", "s(SAVkm)", "s(NoFishRest)", "s(smallbluecrabP120)", "s(reddrumP915forageP915)", "s(reddrumP915forageP120)", "factor(Yearfactor)"))
```
...
#Load formulas
##Red drum
allformulas_reddrum_M3 <- dredgeform(pred = "reddrumP915", covars = c("s(avgdepth)", "s(avgssal)", "s(avgstemp)", "s(avgsdo)", "s(SAVkm)", "s(NoFishRest)", "s(smallbluecrabP120)", "s(clupeidaeP915)", "s(clupeidaeP120)", "s(sciaenidaeP915)", "s(sciaenidaeP120)", "s(sparidaeP915)", "s(sparidaeP120)", "s(penaiedP120)", "s(paralichthyidaeP120)", "factor(Yearfactor)"))
```
