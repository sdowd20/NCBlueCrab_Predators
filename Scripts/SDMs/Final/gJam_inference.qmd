...
xdata_train <- xdata_train %>% select(-NoFishRest)
xdata_test <- xdata_test %>% select(-NoFishRest)

#Model
ml <- list(ng = 60000, burnin = 10000, typeNames = 'CA')

out4 <- gjam(~avgdepth + avgstemp + avgssal + avgsdo + NoFishRest + Yearfactor, xdata = xdata_train, ydata = ydata_train, modelList = ml)

save(out4, file="/Users/sallydowd/Desktop/out4_year.Rdata")

load('/Users/sallydowd/Desktop/out4.Rdata')
...
load('/Users/sallydowd/Desktop/out5.Rdata')
...
load('/Users/sallydowd/Desktop/out8.Rdata')
...
load('/Users/sallydowd/Desktop/out6.Rdata')
...
load('/Users/sallydowd/Desktop/out7.Rdata')
