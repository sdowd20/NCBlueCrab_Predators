...
crust_count <- P120_bioledt %>% filter(Speciescommonname %in% c("periwinkles", "cephalopod molluscs", "mud snails", "pink shrimp", "sevenspine bay shrimp", "flatback mud crab", "oppossum shrimps", "isopods", "atlantic mud crab", "lesser blue crab", "hermit crabs", "mantis shrimp", "snapping shrimps", "hippolyte shrimps", "crayfishes", "florida stone crab", "iridescent swimming crab", "harris mud crab", "white shrimp", "cephalopod mullusc", interest_spp), Year > 2001, Month== 6) %>% group_by(Speciescommonname) %>% mutate(count= n()) %>% distinct(count)
