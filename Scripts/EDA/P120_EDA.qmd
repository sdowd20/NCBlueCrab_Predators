...
crust_count <- P120_bioledt %>% filter(Speciescommonname %in% c("periwinkles", "cephalopod molluscs", "mud snails", "pink shrimp", "sevenspine bay shrimp", "flatback mud crab", "oppossum shrimps", "isopods", "atlantic mud crab", "lesser blue crab", "hermit crabs", "mantis shrimp", "snapping shrimps", "hippolyte shrimps", "crayfishes", "florida stone crab", "iridescent swimming crab", "harris mud crab", "white shrimp", "cephalopod mullusc")) %>% group_by(Speciescommonname) %>% mutate(count= n()) %>% distinct(count)

P120_bioledt %>% filter(Speciescommonname %in% "cephalopod mullusc", Year > 2007, Month== 6) %>% drop_na(Colnum) %>% summarise(sum_Colnum= sum(Colnum))
...
haul$Species=rep_along(haul$Species, c("brown shrimp", "atlantic croaker", "southern flounder", "spot", "blue crab", "atlantic menhaden", "white shrimp", "periwinkles", "pink shrimp", "american shad", "cephalopod mullusc", "juv blue crab", "adult blue crab")) #this repeats these species common names for the entirety of the length of the haul df
