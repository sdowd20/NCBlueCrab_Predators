...
t <- P195_bc_edt %>% filter(Eventname %in% "1931440")
...
diff <- which(P195_bc_prop_edt2$Total_sampled != P195_bc_prop_edt2$Numbertotal) #there are a couple where total_sampled > Numbertotal, weird but seems fine and like a data entry issue on their side
