...
#No outliers for year, month, day, surface salinity, bottom salinity, inlet distance
...
base_plot + geom_point(data = subset(CPUE_all_grid_pred, SAV_km >= 25.7), aes(x = Longitude, y = Latitude, color= SAV_km)) + scale_color_gradient(low = "lightblue", high = "darkblue")
