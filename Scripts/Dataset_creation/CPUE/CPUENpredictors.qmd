...
write.csv(CPUE_length_grid_pred, "~/Desktop/Ch1Data/CPUE/CPUE_all_grid_pred_multi.02.20.24.csv")
```
...
CPUE_dfs_gridded_final_length <- read.csv("~/Desktop/Ch1Data/CPUE/CPUE_all_grid_pred_multi.02.20.24.csv")
...
write.csv(CPUE_grid_length_avg_edt, "~/Desktop/Ch1Data/CPUE/CPUE_grid_avg_lengthedt.02.20.24.csv")
```
